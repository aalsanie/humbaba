...
import io.humbaba.runner.adapters.ConsoleConsentPrompter
import io.humbaba.runner.adapters.DiskFileContentWriter
import io.humbaba.runner.adapters.FileConsentStore
import io.humbaba.runner.adapters.HardenedProcessFormatterRunner
import io.humbaba.runner.adapters.NoOpAiFormatAdvisor
import io.humbaba.runner.adapters.NoOpAiRecommender
import io.humbaba.runner.adapters.NoOpFormatterInstaller
import io.humbaba.runner.adapters.NoOpNativeFormatter
import io.humbaba.runner.adapters.SimpleFileClassifier
...
class HumbabaRunner {
    ...
    private fun buildAi(
        options: RunOptions,
        log: (String) -> Unit,
    ): Pair<io.humbaba.domains.ports.AiRecommender, io.humbaba.domains.ports.AiFormatAdvisor> {
