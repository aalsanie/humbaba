...
object BinaryPins {
    ...
    private val pins: List<io.github.aalsanie.platform.BinaryPins.Pin> = listOf()

    fun find(
        toolId: String,
        version: String,
        os: String,
    ): io.github.aalsanie.platform.BinaryPins.Pin? = io.github.aalsanie.platform.BinaryPins.pins.firstOrNull { it.toolId == toolId && it.version == version && it.os == os }
